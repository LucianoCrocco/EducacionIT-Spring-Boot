package educacionit.comercio.aspect;
...
import educacionit.comercio.services.impl.InteractionServiceImpl;
...
//###########################  nombre de poincuts
    ...
    @Pointcut("execution(* educacionit.comercio.controllers.*.*(..))")
...
// los '..' dos puntos indica que el metodo puede tener 0 o mas parametros.
    ...
    @Before("execution(* educacionit.comercio.controllers.HomeController.*(..))")
    ...
    @Before("execution(* educacionit.comercio.controllers.HomeController.home2(..))")
...
//##############################  Despues de ejecutar el metodo
    ...
    @After("execution(* educacionit.comercio.services.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(java.util.List<educacionit.comercio.entities.Product> educacionit.comercio.services.*.*(..))", returning = "result")
    ...
    //Esta aspecto se ejecuta luego de que las clases observadas lancen una exception
     @AfterThrowing(pointcut = "execution(* educacionit.comercio.services.*.*(..))", throwing = "error")
...
//############################## antes y despues del metodo
   ...
   // @Around("execution(java.util.List<educacionit.comercio.entities.Product> educacionit.comercio.services.*.*(..))")
